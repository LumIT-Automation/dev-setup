...
function System_mariadbSetup()
{
    ...
    cp -f /vagrant/api-extremenetworks/etc/mysql/mariadb.conf.d/51-mariadb.cnf /etc/mysql/mariadb.conf.d
    cp -f /vagrant/api-extremenetworks/etc/mysql/mariadb.conf.d/99-log.cnf /etc/mysql/mariadb.conf.d
...
function System_apacheSetup()
{
    ...
    cp -f /vagrant/api-extremenetworks/etc/apache2/sites-available/001-django.conf /etc/apache2/sites-available/001-django.conf
    chmod 644 /etc/apache2/sites-available/001-django.conf

    # Setup the phpMyAdmin virtual host on port 8300.
    cp -f /vagrant/api-extremenetworks/etc/apache2/sites-available/001-mysql.conf /etc/apache2/sites-available/001-mysql.conf
    ...
    cp -f /vagrant/api-extremenetworks/etc/systemd/system/apache2.service /etc/systemd/system/apache2.service
...
System_consulAgentInstall()
{
    ...
    cp -f /vagrant/api-extremenetworks/etc/consul.d/api.json /etc/consul.d/api.json
    ...
    cp -f /vagrant/api-extremenetworks/usr/bin/consul.sh /usr/bin/consul.sh
    chmod 755 /usr/bin/consul.sh

    cp -f /vagrant/api-extremenetworks/etc/systemd/system/consul.service /etc/systemd/system/consul.service
...
System_syslogngInstall()
{
    ...
    serverAddress="10.0.200.253"
    sed -i '/syslog.host/d' /etc/hosts

    # syslog-ng config files.
    cp -f /vagrant/api-extremenetworks/etc/syslog-ng/conf.d/*conf /etc/syslog-ng/conf.d/
