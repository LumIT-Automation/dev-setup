...
System_mariadbRestore()
{
    ...
    pkgVer=`cat /var/www/aaa/CONTAINER-DEBIAN-PKG/DEBIAN-PKG/deb.release`
    commit=`tail -1 /var/www/aaa/.git/logs/HEAD | awk '{print $2}'`

    mysql -e 'DROP DATABASE IF EXISTS `sso`;'
    mysql -e 'CREATE DATABASE `sso` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT ='"'"'pkgVersion='${pkgVer}' commit='${commit}"'"';'
