...
function System_mariadbSetup()
{
    ...
    cp -f /vagrant/api-secops/etc/mysql/mariadb.conf.d/51-mariadb.cnf /etc/mysql/mariadb.conf.d
    cp -f /vagrant/api-secops/etc/mysql/mariadb.conf.d/99-log.cnf /etc/mysql/mariadb.conf.d
...
function System_apacheSetup()
{
    ...
    cp -f /vagrant/api-secops/etc/apache2/sites-available/001-django.conf /etc/apache2/sites-available/001-django.conf
    chmod 644 /etc/apache2/sites-available/001-django.conf

    # Setup the phpMyAdmin virtual host on port 8300.
    cp -f /vagrant/api-secops/etc/apache2/sites-available/001-mysql.conf /etc/apache2/sites-available/001-mysql.conf
...
System_consulAgentInstall()
{
    ...
    cp -f /vagrant/api-secops/etc/consul.d/api.json /etc/consul.d/api.json
    ...
    cp -f /vagrant/api-secops/usr/bin/consul.sh /usr/bin/consul.sh
    chmod 755 /usr/bin/consul.sh

    cp -f /vagrant/api-secops/etc/systemd/system/consul.service /etc/systemd/system/consul.service
...
System_pipInstallDaemon_api()
{
    ...
    # pip install service.
    cp -f /vagrant/api-secops/etc/systemd/system/pip_install_api.service /etc/systemd/system/pip_install_api.service
    chmod 644 /etc/systemd/system/pip_install_api.service

    # Watchdog service: monitor folder for changes.
    cp -f /vagrant/api-secops/etc/systemd/system/pip_install_api.path /etc/systemd/system/pip_install_api.path
...
#    python /var/www/api/doc/openapi-fix.py -i /var/www/api/doc/swagger0.yaml -o /var/www/api/doc/swagger.yaml -u /var/www/api/secops/secopsUrls.py
