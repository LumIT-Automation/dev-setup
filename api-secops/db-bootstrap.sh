...
System_mariadbRestore()
{
    ...
    mysql api < /var/www/api/secops/sql/secops.schema.sql
    mysql api < /var/www/api/secops/sql/secops.data.sql
    if [ -f /var/www/api/secops/sql/secops.data-development.sql ]; then
        mysql api < /var/www/api/secops/sql/secops.data-development.sql
    fi
}
