...
System_mariadbRestore()
{
    ...
    mysql api < /var/www/api/checkpoint/sql/checkpoint.schema.sql
    mysql api < /var/www/api/checkpoint/sql/checkpoint.data.sql
    if [ -f /var/www/api/checkpoint/sql/checkpoint.data-development.sql ]; then
        mysql api < /var/www/api/checkpoint/sql/checkpoint.data-development.sql
    fi
}
