...
System_vpnSupplicantSetup()
{
    ...
    if [ -f /tmp/.vpn.env ]; then
        ...
        # Systemd VPN service.
        cp -f /vagrant/api-checkpoint/etc/systemd/system/lumitvpn.service /etc/systemd/system/lumitvpn.service
        chmod 644 /etc/systemd/system/lumitvpn.service

        cp -f /vagrant/api-checkpoint/sbin/lumitvpn.sh /sbin/lumitvpn.sh
