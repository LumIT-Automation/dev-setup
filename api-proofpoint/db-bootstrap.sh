...
System_mariadbRestore()
{
    ...
    mysql api < /var/www/api/proofpoint/sql/proofpoint.schema.sql
    mysql api < /var/www/api/proofpoint/sql/proofpoint.data.sql
    if [ -f /var/www/api/proofpoint/sql/proofpoint.data-development.sql ]; then
        mysql api < /var/www/api/proofpoint/sql/proofpoint.data-development.sql
    fi
}
