...
System_mariadbRestore()
{
    ...
    mysql api < /var/www/api/cisco/sql/cisco.schema.sql
    mysql api < /var/www/api/cisco/sql/cisco.data.sql
    if [ -f /var/www/api/cisco/sql/cisco.data-development.sql ]; then
        mysql api < /var/www/api/cisco/sql/cisco.data-development.sql
    fi
}
