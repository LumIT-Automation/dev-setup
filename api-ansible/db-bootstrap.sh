...
System_mariadbRestore()
{
    ...
    mysql api < /var/www/api/ansible/sql/ansible.schema.sql
    mysql api < /var/www/api/ansible/sql/ansible.data.sql
    if [ -f /var/www/api/ansible/sql/ansible.data-development.sql ]; then
        mysql api < /var/www/api/ansible/sql/ansible.data-development.sql
    fi
}
